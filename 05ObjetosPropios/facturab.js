...
factura1.elementos = []
    ...
    // factura1.elementos.push({ Iniciamos así pero en este caso concreto se puede hacer como acontinuacion
...
{ empresa: 
   ...
   cliente: 
    { nombre: 'Libreria Tuatalug',
      ...
      nif: 'K-434344343' },
   elementos: 
    [ { descripcion: 'La Isla del Tesoro', precio: 30, cantidad: 10 },
      { descripcion: 'Dracula', precio: 75, cantidad: 5 },
      { descripcion: 'El Señor de los Anillos',
        precio: 50,
        cantidad: 24 } ],
   importeTotal: 0,
